...
#### 1. From the options file called as `.airgeddonrc` usually located in the same dir as the main script. For some distros like Pentoo located at `/etc/airgeddonrc`.
